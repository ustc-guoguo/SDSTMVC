...
# 1. Warm-up stage: train with inter-view InfoNCE, intra-view InfoNCE, and reconstruction loss
...
# 2. Fine-tuning stage: train with cross-view Universum loss, intra-view Universum loss, and reconstruction loss
